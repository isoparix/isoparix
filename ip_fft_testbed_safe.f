...
c
      ...
      character(1),allocatable,dimension(:,:) :: rpic,tpic
...
c
      ...
      open(38,form='unformatted',status='unknown')
         write(38)sizedim     ! write out the length of the square
      close(38)
c
      allocate(tpic    (sizedim,sizedim))
...
c
      open(36,form='unformatted',status='unknown')
         write(36)cx          ! Write out the image x PSF transform
      close(36)
      write(*,*)'Forward transform product written to fort.36'
c
