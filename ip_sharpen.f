...
c
      ...
      real(8),allocatable,dimension(:,:)   :: con_matrix,blur_array,cmb
...
c
      ...
      allocate(       cmb(-matrix_blur:matrix_blur
...
c        write(*,117)iy,nzero
     ...
     *             blur_array(ix-matrix_blur:ix+matrix_blur
     *                       ,iy-matrix_blur:iy+matrix_blur)+cmb
c    *            +    cm_num(idensity,:,:)
c            
c                  do imy=-matrix_blur,matrix_blur
c                     iby=iy+imy
c                     do imx=-matrix_blur,matrix_blur
c                        ibx=ix+imx
c                        blur_array(iby,ibx)=blur_array(iby,ibx)
c    *                                 +cm_num(idensity,imy,imx)
c                     enddo
c                  enddo
               else
                   nzero=nzero+1    
